...
class User extends Component {
  ...
  handlesubmit = () => {
    ...
    if(!this.state.propertyData.name || !this.state.propertyData.floor_area_size || !this.state.propertyData.num_of_rooms || !this.state.propertyData.description || !this.state.propertyData.address || !this.state.propertyData.lat || !this.state.propertyData.lng || !this.state.propertyData.lng || !this.state.propertyData.price){
            ...
            <Card >
              ...
              <CardBody>
                      ...
                      <Label for="exampleSelect" >Property Status</Label>
                        <Input type="select" name="active" onChange={this.handleOnChange} defaultValue={this.state.propertyData.active}>
